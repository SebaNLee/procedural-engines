...
Repo to store a variety of procedural generation code, intended to be used in my [personal website](https://sebalee.com) as background. Rust for the source code and exporting it as a NPM package to be used with WASM.
